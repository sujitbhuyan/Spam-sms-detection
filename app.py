...
# Load the Multinomial Naive Bayes' pkl model and TF|IDF Vectorizer using pickle module
classifier = pickle.load(open("D:/Sujit-Data Science/Datamites/NLP Project/Spam sms detection-sujit/SMS_Detection_Model.pkl","rb"))
cv = pickle.load(open("D:/Sujit-Data Science/Datamites/NLP Project/Spam sms detection-sujit/vectorizer.pkl","rb"))
